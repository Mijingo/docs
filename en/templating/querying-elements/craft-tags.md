...
Limits the results to *X* tags. Defaults to `null` (no limit).
...
Only fetch tags that match a given search query. (See [Searching](docs/searching.md) for the syntax and available search attributes.)
